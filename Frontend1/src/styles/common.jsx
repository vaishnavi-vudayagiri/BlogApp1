...
export const mutedText = "text-sm text-gray-300";
...
// ─── Forms ────────────────────────────────────────────
export const formCard = "bg-[#f5f5f7] rounded-2xl p-10 max-w-4xl mx-auto shadow-2xl shadow-gray-500";
export const formTitle = "text-3xl font-bold text-purple-400 tracking-tight text-center mb-7";
export const labelClass = "text-xs font-medium text-slate-700 mb-1.5 block";
export const inputClass = "w-full bg-white border border-black  rounded-xl px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#0066cc] focus:ring-2 focus:ring-[#0066cc]/10 transition";
export const formGroup = "mb-4";
export const submitBtn ="w-full bg-gradient-to-r from-blue-300 to-blue-600 text-white font-semibold py-2.5 rounded-full hover:bg-blue-900 cursor-pointer mt-2 text-sm tracking-tight";
